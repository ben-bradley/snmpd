...
var Server = function(options) {
	...
	server.bind(options.port || 161);
	
};

var ParseRequest = function(msg) {
	...
	req.type = PduType[reader.readSequence()];
	
	if (req.type == 'GetRequest') {
		req.num = reader.readInt();
		// .unk = [ 0, 0, 48, 48 ];
		req.unk = [ reader.readInt(), reader.readInt(), reader.readSequence(), reader.readSequence() ];
		req.oid = reader.readOID();
	}
